...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLandsat = QAction(MainWindow)
        self.actionLandsat.setObjectName(u"actionLandsat")
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.gbScience = QGroupBox(self.centralwidget)
        self.gbScience.setObjectName(u"gbScience")
        self.gbScience.setGeometry(QRect(40, 20, 401, 121))
        ...
        icon = QIcon()
        icon.addFile(u"icons8-astronaut-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"icons8-sonne-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"observatory.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons8-europa-96.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons8-mars-60.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbMarsRoverPictures.setIcon(icon4)
        self.pbLandsat = QPushButton(self.gbScience)
        self.pbLandsat.setObjectName(u"pbLandsat")
        self.pbLandsat.setGeometry(QRect(320, 40, 51, 51))
        self.pbLandsat.setLayoutDirection(Qt.LeftToRight)
        icon5 = QIcon()
        icon5.addFile(u"icons8-satellite-im-orbit-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbLandsat.setIcon(icon5)
        self.pbLandsat.setIconSize(QSize(51, 51))
        ...
        icon6 = QIcon()
        icon6.addFile(u"icons8-colors-58.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbColors.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"icons8-bmo-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbBored.setIcon(icon7)
        self.pbXKCD = QPushButton(self.gbFun)
        self.pbXKCD.setObjectName(u"pbXKCD")
        self.pbXKCD.setGeometry(QRect(90, 40, 51, 51))
        icon8 = QIcon()
        icon8.addFile(u"television_klein.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbXKCD.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u"icons8-gesangslehrer-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbLyrics.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u"icons8-recipe-book-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pbRecipeDB.setIcon(icon10)
        ...
        self.pbLandsat.clicked.connect(self.actionLandsat.trigger)
...
#endif // QT_CONFIG(tooltip)
        self.actionLandsat.setText(QCoreApplication.translate("MainWindow", u"Landsat", None))
#if QT_CONFIG(tooltip)
        self.actionLandsat.setToolTip(QCoreApplication.translate("MainWindow", u"Get Landsat Imagery", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pbLandsat.setToolTip(QCoreApplication.translate("MainWindow", u"Get Landsat Images", None))
#endif // QT_CONFIG(tooltip)
        self.pbLandsat.setText("")
